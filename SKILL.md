...
**默认版**：
> 这里躺着一个收藏了 89 本书"想读"、读完 2 本的乐观主义者。TA 在微博忧国忧民，在小红书岁月静好，在 B 站……这个就不说了。TA 这一生最大的执念是猫——虽然从未养过，但收藏夹可以证明，TA 为一只不存在的猫准备了一整个世界。
...
**赛博版**：
> `process "life" terminated unexpectedly.`
> `Total commits: 347. PRs merged: 2. Issues opened: 89 (87 still open).`
> `Most frequent keyword in cache: "猫" (67% hit rate).`
> `Last active: 01:37 AM. Uptime pattern: nocturnal.`
...
- "TA 的互联网人生始于 2016 年春天，那时候 TA 还相信努力就有回报。"
- "如果 TA 的墓碑能刻一个 emoji，应该是 🐱。"
- "TA 给世界留下了 347 条痕迹，悄悄藏起了 1,203 个秘密偏好。一个慷慨的旁观者。"

**坏的**：
- "你的阅读量严重不足"（说教）
- "你的人生缺乏深度"（评判）
- "你应该多出去走走"（建议——墓志铭不给建议，死人不需要建议）

### 与照妖镜的语气区分

| 照妖镜 🪞 | 墓志铭 🪦 |
|----------|----------|
| "你嘴上说极简，收藏全是种草" | "TA 曾经想过极简生活。收藏夹表示反对。" |
| "健身人设崩塌！" | "TA 的跑鞋还是新的。永远是新的。" |
| 损友吐槽 | 好友致辞 |
| 揭穿 | 回忆 |
